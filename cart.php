...
<html>
<head>
<title>PetsQuShop's - Keranjang Saya</title>
<!-- for-mobile-apps -->
        ...
        <div class="container">
            ...
            <div class="product_list_header">
                <ul>
                    ...
                    if (!isset($_SESSION['log'])) {
                        echo '
					<a href="registered.php"> Daftar</a>
					...
					';
                        ...
                        if ($_SESSION['role'] == 'Member') {
                            echo '
					<p style="color:white">Halo, ' . $_SESSION["name"] . '
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Jl.In.Ajh Dulu</li>
